...
class MainActivity : AppCompatActivity() {
    ...
    fun setTime(v:View?){
        TimePickerDialog(this@MainActivity, time,
            ...
            dateAndTime[Calendar.MINUTE],true).show()
    }
    ...
    var date = DatePickerDialog.OnDateSetListener { view, year, mounthOfYear, dayOfMounth ->
        dateAndTime[Calendar.YEAR] = year
        dateAndTime[Calendar.MONTH] = mounthOfYear
        dateAndTime[Calendar.DAY_OF_MONTH] = dayOfMounth
        setInitialDateTime()
    }
